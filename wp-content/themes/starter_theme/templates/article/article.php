...
function starter_theme_modify_taxonomy() {
...
add_action( 'init', 'starter_theme_modify_taxonomy', 999 );
...
function starter_theme_article_admin_menu() {
 //remove_submenu_page('edit.php', 'edit-tags.php?taxonomy=post_tag');
}
add_action( 'admin_menu', 'starter_theme_article_admin_menu', 999);
